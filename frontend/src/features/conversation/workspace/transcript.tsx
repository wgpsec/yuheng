...
import { ListTodo, Maximize2, Pencil, RefreshCw, X } from 'lucide-react';
...
export function Transcript({ messages, isThinking, activities = [], runs = [], recoveryNotice, latestUsage, requestedMessageId, onRequestedMessageHandled, onOpenTask, onCreateTask, onEditLastUser, onRegenerate }: { messages: TranscriptMessage[]; isThinking: boolean; activities?: ToolActivity[]; runs?: RunSummary[]; recoveryNotice?: RecoveryNotice | null; latestUsage?: RunUsageView | null; requestedMessageId?: string | null; onRequestedMessageHandled?: () => void; onOpenTask?: (boardId: string, taskId: string) => void; onCreateTask?: (message: TranscriptMessage) => void; onEditLastUser?: (message: TranscriptMessage) => void; onRegenerate?: () => void }) {
